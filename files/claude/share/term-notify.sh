#!/bin/bash
# Sends a bell + OSC 777 notification to the parent terminal.
...
# Send OSC 777 desktop notification + bell to the terminal
printf '\e]777;notify;Claude Code;%s\e' "$MSG" > "$TTY"
printf '\a' > "$TTY"
